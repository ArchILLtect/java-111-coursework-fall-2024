/**
 *   This sub class holds information about a CheckingAccount (Assignment 2, Unit 4)
 *   @author Nick Hanson
 *     - Created 11/23/24
 */
...
public class CheckingAccount extends BankAccount {
    ...
    /** Return class name and the balance of the CheckingAccount.
     *  @return a string containing the classname and checking account balance.
     */
    @Override
